# Generated by Django 5.1.4 on 2025-01-26 00:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minimum_term', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)])),
                ('maximum_term', models.IntegerField(blank=True, null=True)),
                ('deposit', models.DecimalField(decimal_places=2, max_digits=10)),
                ('bills_included', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('furnishings', models.CharField(max_length=255)),
                ('parking', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('garden', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('balcony', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('disabled_access', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('living_room', models.CharField(choices=[('shared', 'Shared'), ('private', 'Private')], max_length=7)),
                ('broadband', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ...
                ('couples_ok', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('smoking_ok', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('pets_ok', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
                ('occupation_preference', models.CharField(max_length=100)),
                ('references_required', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
